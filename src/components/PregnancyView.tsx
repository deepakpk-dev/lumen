...
export function PregnancyView() {
  ...
  return (
    <PageShell title="Pregnancy" subtitle="Your week by week, kicks, and contractions.">
      <PregnancyCard
        gestation={gestation}
      ...
      <nav className="grid grid-cols-2 gap-3 text-center text-sm">
        <NavTile href="/pregnancy/kicks">Kick counter</NavTile>
        <NavTile href="/pregnancy/contractions">Contraction timer</NavTile>
        <NavTile href="/log">Log symptoms</NavTile>
        <NavTile href="/settings">Manage pregnancy</NavTile>
      </nav>
